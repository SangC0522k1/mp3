...
$(document).ready(function () {
    $("audio").on("timeupdate", function (e) {
        ...
        var past = _data["melody"].filter(function (item) {
            return item[0].time < time;
        });
        if (_data["melody"][past.length] != currentLine) {
            currentLine = _data["melody"][past.length];
...
function pronounce() {
    var html = "";
    for (var i = 0; i < _data["melody"].length; i++) {
        html += "<div";
        if (i == 0) {
        ...
        html += ">";
        for (let j = 0; j < _data["melody"][i].length; j++) {
            html += " <span "
            html += ` data-text="${_data["melody"][i][j]["line"]}" >`;
            html +=
                _data["melody"][i][j]["line"] == "" ? " 🌸 " : _data["melody"][i][j]["line"];
            html += " </span>"
